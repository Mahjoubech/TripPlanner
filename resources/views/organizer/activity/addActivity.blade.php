...
<div class="container mx-auto py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Provide the details for your new activity</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="duration" name="duration" class="form-input" value="{{ old('duration') }}" required>
                        @error('duration')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" class="form-input" value="{{ old('price') }}" required>
                        @error('price')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <div class="text-sm text-gray-500 mt-2">Upload a high-quality image of the activity</div>
