...
<div class="container mx-auto py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Update the details for your hotel</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-input" value="{{ old('name', $hotel->name) }}" required>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" rows="6" class="form-input" required>{{ old('description', $hotel->description) }}</textarea>
                        @error('description')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="address" name="address" class="form-input" value="{{ old('address', $hotel->address) }}" required>
                        @error('address')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="city" name="city" class="form-input" value="{{ old('city', $hotel->city) }}" required>
                        @error('city')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="country" name="country" class="form-input" value="{{ old('country', $hotel->country) }}" required>
                        @error('country')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="amenities" name="amenities" rows="4" class="form-input" placeholder="Comma-separated values, e.g., Free WiFi, Pool, Gym" required>{{ old('amenities', $hotel->amenities) }}</textarea>
                        @error('amenities')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <!-- Preview Section -->
                        <div id="image-preview-container" class="mt-4 {{ $hotel->image ? '' : 'hidden' }}">
                            <img id="image-preview" src="{{ $hotel->image ? asset('storage/' . $hotel->image) : '' }}" alt="Image Preview" class="rounded-lg shadow-md w-full h-40 object-cover">
                        </div>
                    </div>
                </div>
            </div>
