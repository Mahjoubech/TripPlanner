...
<div class="container mx-auto py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Add New Transport</h1>
            <p class="text-gray-600 mt-1">Provide the details for your new transport</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="type" name="type" class="form-input" value="{{ old('type') }}" required>
                        @error('type')
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="details" name="details" rows="6" class="form-input">{{ old('details') }}</textarea>
                        @error('details')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="capacity" name="capacity" class="form-input" value="{{ old('capacity') }}" required>
                        @error('capacity')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="features" name="features" rows="4" class="form-input" placeholder="e.g., WiFi, Air Conditioning, Reclining Seats">{{ old('features') }}</textarea>
                        @error('features')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @error('image')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                        <div class="text-sm text-gray-500 mt-2">Upload a high-quality image of the transport</div>
